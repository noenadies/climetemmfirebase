...
function cargaimaeditext(){
  ...
  game.load.image('btf1', 'btf1.png');
    game.load.image('btmes', 'btmes.png');
    
        game.load.image('btdia', 'btday.png');
        
        
  game.load.image('btf2', 'bthour.png');
  game.load.image('btf3', 'btgo.png');
 ...
 game.load.image('btflechai', 'btflechai.png');
  ...
  game.load.image('btxmin', 'bthu.png');

  game.load.image('btxmax', 'bthe.png');
...
this.charantes_f1=[];
 ...
 //var  style={ font: "bold "+String(vw*0.04)+"px Arial", fill: "#B21437", boundsAlignH: "center", boundsAlignV: "middle" };
        ...
        this.style_f1 = { font: "bold "+String(vw*0.04)+"px Arial", fill: "#1080A4", boundsAlignH: "center", boundsAlignV: "middle" };
 
  
     

       this.text_f1= game.add.text(vw/2-(vw/2*0.9), vh/2-vh/2*0.85, "Year", this.style_f1);
...
this.booltexto_mes=false;
this.valortexto_mes="";
this.contarborrarchar_mes=1;
this.charantes_mes=[];
 this.charantes_mes[0]="";
 this.textoactual_mes="";
 this.charantes_mes[-1]="";
 this.charantes_mes[-2]="";


  
 //var  style={ font: "bold "+String(vw*0.04)+"px Arial", fill: "#B21437", boundsAlignH: "center", boundsAlignV: "middle" };
 
        this.tamanotexto_mes=vw*0.01;
   
        this.style_mes = { font: "bold "+String(vw*0.04)+"px Arial", fill: "#1080A4", boundsAlignH: "center", boundsAlignV: "middle" };
 
  
     

       this.text_mes= game.add.text(this.text_f1.x+60, this.text_f1.y, "mes", this.style_mes);
   
    
       this.text_mes.setShadow(3, 3, 'rgba(0,0,0,0.5)', 2);
...
this.valortexto_dia="";
this.contarborrarchar_dia=1;
this.charantes_dia=[];
 this.charantes_dia[0]="";
 this.textoactual_dia="";
 this.charantes_dia[-1]="";
 this.charantes_dia[-2]="";


  
 //var  style={ font: "bold "+String(vw*0.04)+"px Arial", fill: "#B21437", boundsAlignH: "center", boundsAlignV: "middle" };
 
        this.tamanotexto_dia=vw*0.01;
   
        this.style_dia = { font: "bold "+String(vw*0.04)+"px Arial", fill: "#1080A4", boundsAlignH: "center", boundsAlignV: "middle" };
 
  
     

       this.text_dia= game.add.text(this.text_mes.x+60, this.text_f1.y, "dia", this.style_dia);
   
    
       this.text_dia.setShadow(3, 3, 'rgba(0,0,0,0.5)', 2);
...
this.charantes_f2=[];
 ...
 //var  style={ font: "bold "+String(vw*0.04)+"px Arial", fill: "#B21437", boundsAlignH: "center", boundsAlignV: "middle" };
       ...
       // this.style_f2 = { font: "bold "+String(vw*0.04)+"px Arial", fill: "#000000", boundsAlignH: "center", boundsAlignV: "middle" };
     ...
     this.style_f2 = { font: "bold "+String(vw*0.04)+"px Arial", fill: "#000000", boundsAlignH: "center", boundsAlignV: "middle" };
       ...
       this.text_f2= game.add.text(this.text_f1.x+30, this.text_f1.y+33, "", this.style_f2);
...
this.charantes_xmin=[];
 ...
 this.charantes_xmin[-2]="";
        ...
        this.style_xmin = { font: "bold "+String(vw*0.04)+"px Arial", fill: "#1080A4", boundsAlignH: "center", boundsAlignV: "middle" };
 
  
     

       this.text_xmin= game.add.text(this.text_f3.x+22, this.text_f3.y+33, "", this.style_xmin);
   
    
       this.text_xmin.setShadow(3, 3, 'rgba(0,0,0,0.5)', 2);


        this.style_xmax = { font: "bold "+String(vw*0.04)+"px Arial", fill: "#1080A4", boundsAlignH: "center", boundsAlignV: "middle" };
...
btmes = game.add.sprite(vw/2, vh/2- vh/2, 'btmes');
btmes.scale.set(vw*0.0012);
btmes.inputEnabled = true;
btmes.input.useHandCursor = true;


btmes.events.onInputOver.add(fbtmes_onOver, this);
btmes.events.onInputOut.add(fbtmes_onOut, this);
btmes.events.onInputDown.add(fbtmes_onDown, this);


function fbtmes_onOver(bt){
...
function fbtmes_onOut(){
this.sprite.animations.stop('bt',true);
this.sprite.visible =false;

  
}
function fbtmes_onDown(){

this.visiblebasico(true);
this.booltexto_f2=false;
this.booltexto_f3=false;
this.booltexto_f1=false;
this.booltexto_mes=true;
this.booltexto_dia=false;
...
if(this.valortexto_mes=='undefined'){
this.valortexto_mes="";
  
}
if(this.booltexto_mes===true){
    
    
  this.charantes_mes[this.contarborrarchar_mes]=this.valortexto_mes;
   this.valortexto_mes=this.charantes_mes[this.contarborrarchar_mes]+"";


    this.mostrartexto(this.text_mes,this.valortexto_mes);
 
this.mes=this.valortexto_mes;
this.contarborrarchar_mes=this.contarborrarchar_mes+1;
}
...
btdia = game.add.sprite(vw/2, vh/2- vh/2, 'btdia');
btdia.scale.set(vw*0.0012);
btdia.inputEnabled = true;
btdia.input.useHandCursor = true;


btdia.events.onInputOver.add(fbtdia_onOver, this);
btdia.events.onInputOut.add(fbtdia_onOut, this);
btdia.events.onInputDown.add(fbtdia_onDown, this);


function fbtdia_onOver(bt){
...
function fbtdia_onOut(){
this.sprite.animations.stop('bt',true);
this.sprite.visible =false;

  
}
function fbtdia_onDown(){

this.visiblebasico(true);
this.booltexto_f2=false;
this.booltexto_f3=false;
this.booltexto_f1=false;
this.booltexto_dia=true;
this.booltexto_mes=false;
...
if(this.valortexto_dia=='undefined'){
this.valortexto_dia="";
  
}
if(this.booltexto_dia===true){
    
    
  this.charantes_dia[this.contarborrarchar_dia]=this.valortexto_dia;
   this.valortexto_dia=this.charantes_dia[this.contarborrarchar_dia]+"";


    this.mostrartexto(this.text_dia,this.valortexto_dia);
 
this.dia=this.valortexto_dia;
this.contarborrarchar_dia=this.contarborrarchar_dia+1;
}
...
this.horatemp=this.valortexto_f2;
...
this.demesanos=1/12;
this.dediaano=22/365;
this.floatano=2019+this.dediaano+this.demesanos;
this.altura="2640";
this.humedad="66";
this.anodiferen=-1*(2018-(this.floatano))/100;
this.anotem =6*Math.asinh(this.anodiferen)+Math.sin(this.anodiferen);
this.tempalturamin=-0.00530303*parseFloat(this.altura)+25+this.anotem;
...
this.anotem =Math.log(this.anodiferen)//6*ln(this.anodiferenx+Math.pow(Math.pow(this.anodiferen,2)+1,1/2));//+Math.sin(this.anodiferen);
...
if(this.booltexto_mes===true){
  ...
  this.charantes_mes[this.contarborrarchar_mes]=this.valortexto_mes;
   this.valortexto_mes=this.charantes_mes[this.contarborrarchar_mes]+"0";
...
if(this.booltexto_dia===true){
  ...
  this.charantes_dia[this.contarborrarchar_dia]=this.valortexto_dia;
   this.valortexto_dia=this.charantes_dia[this.contarborrarchar_dia]+"0";
...
if(this.booltexto_mes===true){
  ...
  this.charantes_mes[this.contarborrarchar_mes]=this.valortexto_mes;
   this.valortexto_mes=this.charantes_mes[this.contarborrarchar_mes]+"1";
...
if(this.booltexto_dia===true){
  ...
  this.charantes_dia[this.contarborrarchar_dia]=this.valortexto_dia;
   this.valortexto_dia=this.charantes_dia[this.contarborrarchar_dia]+"1";
...
if(this.booltexto_mes===true){
  ...
  this.charantes_mes[this.contarborrarchar_mes]=this.valortexto_mes;
   this.valortexto_mes=this.charantes_mes[this.contarborrarchar_mes]+"2";
...
if(this.booltexto_dia===true){
  ...
  this.charantes_dia[this.contarborrarchar_dia]=this.valortexto_dia;
   this.valortexto_dia=this.charantes_dia[this.contarborrarchar_dia]+"2";
...
if(this.booltexto_mes===true){
  ...
  this.charantes_mes[this.contarborrarchar_mes]=this.valortexto_mes;
   this.valortexto_mes=this.charantes_mes[this.contarborrarchar_mes]+"3";
...
if(this.booltexto_dia===true){
  ...
  this.charantes_dia[this.contarborrarchar_dia]=this.valortexto_dia;
   this.valortexto_dia=this.charantes_dia[this.contarborrarchar_dia]+"3";
...
if(this.booltexto_mes===true){
  ...
  this.charantes_mes[this.contarborrarchar_mes]=this.valortexto_mes;
   this.valortexto_mes=this.charantes_mes[this.contarborrarchar_mes]+"4";
...
if(this.booltexto_dia===true){
  ...
  this.charantes_dia[this.contarborrarchar_dia]=this.valortexto_dia;
   this.valortexto_dia=this.charantes_dia[this.contarborrarchar_dia]+"4";
...
if(this.booltexto_mes===true){
  ...
  this.charantes_mes[this.contarborrarchar_mes]=this.valortexto_mes;
   this.valortexto_mes=this.charantes_mes[this.contarborrarchar_mes]+"5";
...
if(this.booltexto_dia===true){
  ...
  this.charantes_dia[this.contarborrarchar_dia]=this.valortexto_dia;
   this.valortexto_dia=this.charantes_dia[this.contarborrarchar_dia]+"5";
...
if(this.booltexto_mes===true){
  ...
  this.charantes_mes[this.contarborrarchar_mes]=this.valortexto_mes;
   this.valortexto_mes=this.charantes_mes[this.contarborrarchar_mes]+"6";
...
if(this.booltexto_dia===true){
  ...
  this.charantes_dia[this.contarborrarchar_dia]=this.valortexto_dia;
   this.valortexto_dia=this.charantes_dia[this.contarborrarchar_dia]+"6";
...
if(this.booltexto_mes===true){
  ...
  this.charantes_mes[this.contarborrarchar_mes]=this.valortexto_mes;
   this.valortexto_mes=this.charantes_mes[this.contarborrarchar_mes]+"7";
...
if(this.booltexto_dia===true){
  ...
  this.charantes_dia[this.contarborrarchar_dia]=this.valortexto_dia;
   this.valortexto_dia=this.charantes_dia[this.contarborrarchar_dia]+"7";
...
if(this.booltexto_mes===true){
  ...
  this.charantes_mes[this.contarborrarchar_mes]=this.valortexto_mes;
   this.valortexto_mes=this.charantes_mes[this.contarborrarchar_mes]+"8";
...
if(this.booltexto_dia===true){
  ...
  this.charantes_dia[this.contarborrarchar_dia]=this.valortexto_dia;
   this.valortexto_dia=this.charantes_dia[this.contarborrarchar_dia]+"8";
...
if(this.booltexto_mes===true){
  ...
  this.charantes_mes[this.contarborrarchar_mes]=this.valortexto_mes;
   this.valortexto_mes=this.charantes_mes[this.contarborrarchar_mes]+"9";
...
if(this.booltexto_dia===true){
  ...
  this.charantes_dia[this.contarborrarchar_dia]=this.valortexto_dia;
   this.valortexto_dia=this.charantes_dia[this.contarborrarchar_dia]+"9";
...
this.valortexto_dia="";
    ...
    if(this.contarborrarchar_dia<-0.1){
this.contarborrarchar_dia=0;
}
this.contarborrarchar_dia=this.contarborrarchar_dia-1;
  
    this.charantes_dia[this.contarborrarchar]=this.charantes_dia[this.contarborrarchar_dia];
  this.valortexto_dia =this.charantes_dia[this.contarborrarchar_dia]
...
this.valortexto_mes="";
    ...
    if(this.contarborrarchar_mes<-0.1){
this.contarborrarchar_mes=0;
}
this.contarborrarchar_mes=this.contarborrarchar_mes-1;
  
    this.charantes_mes[this.contarborrarchar]=this.charantes_mes[this.contarborrarchar_mes];
  this.valortexto_mes =this.charantes_mes[this.contarborrarchar_mes]
...
//this.humedad=this.valortexto_xmin;
this.humedad=this.valortexto_xmin;
...
this.altura=this.valortexto_xmax;
...
this.update=function(){
   ...
   btf1.position.y=btcero.position.y-vh*0.86-5;
   
   btmes.position.x= btf1.position.x+80;
   btmes.position.y= btf1.position.y;
   
    btdia.position.x= btmes.position.x+80;
   btdia.position.y= btmes.position.y;
    btf2.position.x= btcero.position.x+vw*0;
   btf2.position.y=btcero.position.y-vh*0.76-6;
...
this.fijaracambasico =function(fijar){
  ...
  btmes.fixedToCamera=fijar;
    btdia.fixedToCamera=fijar;
...
btxy.fixedToCamera=fijar;
 ...
 this.text_mes.fixedToCamera=fijar;
  this.text_dia.fixedToCamera=fijar;
